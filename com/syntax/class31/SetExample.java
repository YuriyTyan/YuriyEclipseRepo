...
public class SetExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("----- Using for each loop to get values from it object ------");
		//is there other way to get all elements from Set collections?
		for(String br : brand) {
		...
		System.out.println("------ Creating an object of Tree Set ----");
		...
		System.out.println("------  Creating an object of Tree Set to store double----");
