...
public class MethodsWithReturn {
	...
	//create a method that will accept two int values and return the largest number
	...
	//create a method that will accept String value and returns that value all inb upper case
